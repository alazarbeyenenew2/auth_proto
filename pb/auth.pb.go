...
const file_auth_proto_rawDesc = "" +
	...
	"\x04user\x18\x01 \x01(\v2\x05.UserR\x04user\x12\x1f\n" +
...
var file_auth_proto_goTypes = []any{
	...
	(*AuthzResponse)(nil),         // 5: AuthzResponse
	(*AuthorizationRequest)(nil),  // 6: AuthorizationRequest
	(*User)(nil),                  // 7: User
}
var file_auth_proto_depIdxs = []int32{
	7, // 0: RegisterRequest.user:type_name -> User
	7, // 1: RegisterResponse.user:type_name -> User
	0, // 2: Authz.Login:input_type -> LoginRequest
	1, // 3: Authz.Login:output_type -> LoginResponse
